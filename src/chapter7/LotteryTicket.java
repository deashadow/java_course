...
public class LotteryTicket {
    private static final int LENGTH = 6; //in capital,, fixed number--will not change
    private static final int MAX_TICKET_NUMBER = 69;//do not want magic numbers
    ...
    public static int[] generateNumbers(){
        ...
        for(int i=0; i< LENGTH; i++){
            ...
            already exist in the array. If it does, regenerate
            and search again.
            DO NOT want duplicate numbers
             */
            do{
